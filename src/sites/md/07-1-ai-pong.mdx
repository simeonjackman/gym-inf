...
Variablen umbenennen oder Stile ändern. Sie sehen dann auch sehr schnell, dass
...
kann es sehr gut sein, dass die Stile direkt im HTML sind, und nicht in einer
