...
Der ASCII-Code ist ein Code der jedem Zeichen eine Zahl zuweist. Das braucht der
Cumputer da er wissen muss welches Zeichen er darstellen soll, denn der Computer
kann selber nur mit Zahlen umgehen.

In dieser Tabelle ist festgehalten welche Zahl im ASCII-Code welchem Zeichen
entspricht:
...
In dieser Tabelle können wir zum Beispiel ablesen dass alle Buchstaben am Stück
...
Wir könnten nun noch weitere Fälle einbauen, um komplexere Überprüfungen zu
erstellen.
...
Wenn Sie die Tabelle genau anschauen, dann sehen Sie das die Buchstaben im
ASCII-Code bereits schön sortiert sind. Das macht es sehr praktisch wenn wir
einen vergleichsbasierten Sortieralgorithmus schreiben möchten.
