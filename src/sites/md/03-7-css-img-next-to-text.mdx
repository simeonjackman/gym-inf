...
Bild neben Text zu haben ist relativ einfach. Das muss auch nicht unbedingt ein
Bild sein, es sind einfach 2 Container nebeneinander.

Verwenden Sie dafür den folgenden HTML Code:

```html
<div class="text-next-to-img">
...
/* Gibt Stile für den Textblock an. */
...
Es können auch mehrere Spalten eingefügt werden. Diese müssen nur mit der
gewünschten Breite bei `grid-template-column` eingefügt werden.
