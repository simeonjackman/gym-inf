...
Schalter sind verschiedene Fälle die in Javascript auftretten können. Mit
...
Solange wir nur 2 Fälle haben, ist der Code sehr einfach. Mit mehr Fällen kann
es komplexer werden, aber nicht unbedingt schwieriger.
