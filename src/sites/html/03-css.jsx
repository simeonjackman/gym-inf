    ...
    <Chapter hash={"css"}>
      ...
      <section>
        ...
        <p>
          ...
          können Stylesheets in Webseiten eingebunden werden. Damit können
          Styles auch auf mehreren Webseiten verwendet werden, und müssen nicht
          immer wiederholt werden.
        </p>
        <Example title="Aufgabe: Stylesheet verlinken">
          Fügen Sie den folgenden Code im <Tag>head</Tag> von Ihrem HTML
          Dokument ein.
