    ...
    <Chapter hash={"git"}>
      ...
      <section>
        ...
        <p>
          ...
          Ein Projekt besteht also aus einer Reihe von <ICode>commit</ICode>s,
          die durch Änderungen miteinander verbunden sind.
        </p>
        <p>
          Jeder <ICode>commit</ICode> in <b>Git</b> muss eine Nachricht haben,
          die die Änderung beschreibt, die seit dem letzten{" "}
          <ICode>commit</ICode> gemacht wurde. Diese Änderungsnachricht soll
          sehr kurz aber beschreibend sein.
        </p>
        <Example title="Beispiel: Commit-Nachricht">
          <p>
            ...
            Version sein kann, da die Änderung gross genug und sinnvoll ist,
            aber nicht mit anderen Dingen verflochten ist.
          </p>
          <p>
            Eine mögliche <ICode>commit</ICode>-Nachricht dafür wäre:
          </p>
          <Code>Alle Bilder zentriert, und Beschreibung hinzugefügt.</Code>
        </Example>
        <p>
          Die <ICode>commit</ICode>-Nachricht, sollte Ihnen helfen eine Änderung
          wieder zu finden, oder wenn Sie das Projekt nicht (mehr) kennen,
          sollten Sie interessante Änderungen schnell sehen.
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          Dateien zu lesen. Die Änderungen zusammen mit der{" "}
          <ICode>commit</ICode>-Nachricht, ergeben eine Art Selbstdokumentation,
          Sie müssen dadurch nicht extra noch Notizen mitschreiben.
        </p>
