  ...
  return (
    <Chapter>
      ...
      <section>
        ...
        <ICode>branches</ICode> Änderungen an den gleichen Codestellen (Zeilen)
        gemacht wurden. Diese müssen dann von Hand gelöst werden.
      </section>
      <section>
        ...
        Versionen akzeptiert wird. Manchmal müssen aber noch Anpassungen gemacht
        werden.
      </section>
      <Example title="Beispiel: Merge Konflikt im CSS">
        ...
        <section>
          ...
          <ICode>design-B</ICode> verwendet abgerundete Ecken und einen dickeren
