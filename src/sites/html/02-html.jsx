  ...
  return (
    <Chapter hash={"html"}>
      ...
      <section>
        ...
        <p>
          Mit <Tag>h1</Tag> sagen Sie dem Computer dass nun ein Titel folgt. Dann wird all der Text bis <Tag>/h1</Tag> als Titel interpretiert.
        </p>
        <p>
          Neben <Tag>h1</Tag> gibt es auch kleinere Titel <Tag>h2</Tag>, <Tag>h3</Tag>, ..., <Tag>h6</Tag>. Versuchen Sie auch diese in Ihr Dokument zu integrieren.
        </p>
      </section>
      <section>
      ...
      <section>
        <h3>Abschnitt</h3>
        Um in <b>HTML</b> einen Abschnitt zu machen, brauchen Sie das <Tag>p</Tag>-Tag. Alles was darin ist, wird als Abschnitt betrachtet. <b>HTML</b> ignoriert Zeilenumbrüche und mehrfache Leerzeichen um Dokumente konsistent anzuzeigen. Damit Sie Abschnitte verwenden können, brauchen Sie also <Tag>p</Tag>.
      </section>
      <section>
        <h3>Listen</h3>
        <p>
      ...
      <section>
        <h3>Bilder</h3>
        <p>Bilder können sie mit dem <Tag>img</Tag>-Tag einfügen. Dazu ein einfaches Beispiel.</p>
        <Code>
