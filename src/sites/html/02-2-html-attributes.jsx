    ...
    <Chapter hash={"html-attributes"}>
      ...
      <section>
        ...
        <Example title="Beispiel: Links">
          ...
          Informationen braucht. Das Element selbst bekommt den Text, der auf
          der Webseite angezeigt wird, zusätzlich muss man dem Tag aber noch
          sagen auf welche Webseite verlinkt werden soll.
          <Code>
      ...
      <section>
        ...
        <Example title="Aufgabe: Bilder hinzufügen">
          <a href="https://www.w3schools.com/html/html_images.asp">Hier</a>{" "}
          finden Sie alles was Sie über Bilder wissen müssen. Testen Sie es aus,
          indem Sie Bilder von verschiedener Grösse in Ihre Webseite einfügen.
        </Example>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          können. Wichtig dabei ist das IDs beschreibend für das Element sind,
          und eindeutig auf der Webseite vergeben sind.
        </p>
        ...
        <p>
          <b>IDs</b> werden verwendet um spezielle Elemente zu kennzeichnen.
          Diese können dann speziell gestaltet werden, oder man kann darauf
          verlinken innerhalb einer Webseite. Die Webseite scrollt dann direkt
          zu dem Element das Sie verlinkt haben.
        </p>
      ...
      <section>
        ...
        <Example title="Beispiel: Sehr wichtige Elemente">
          Mit <Tag>strong</Tag> können Sie ein wichtiges Element hervorheben.
          Aber auch <Tag>em</Tag> hebt wichtige Elemente hervor. Wir können aber
          auch noch ein sehr wichtiges Element haben.
          <Code>
          ...
          <p>
            Sind jeweils super wichtige Elemente, werden aber anders
            dargestellt.
          </p>
        </Example>
      </section>
