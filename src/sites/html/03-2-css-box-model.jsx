...
export default function ChapterCSSBoxModel() {
  return (
    <Chapter hash={"css-box-model"}>
      ...
      <section>
        ...
        <ul>
          <li>
            <ICode>margin</ICode>: Der äussere Rand, also der Abstand zu anderen
            Elementen.
          </li>
          <li>
            <ICode>border</ICode>: Der Rand von einem Element. Dieser ist
            normalerweise nicht sichtbar, kann aber verwendet werden um Elemente
            zu umranden.
          </li>
          <li>
            <ICode>padding</ICode>: Der innere Rand, also der Abstand vom Inhalt
            zur <ICode>border</ICode>.
          </li>
          <li>
  ...
  height: 70px;
      ...
      <Example title="Aufgabe: Farbiger Rand auf der linken Seite">
        ...
        ansprechen. Erstellen Sie eine Klasse <ICode>danger</ICode> die auf der
        linken Seite einen roten Rand von 5 Pixeln hat.
      </Example>
