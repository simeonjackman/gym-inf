...
export default function ChapterCSSSelectors() {
  ...
  property: value;
        ...
        <p>
          ...
          für diese Eigenschaft. Eine grüne Schriftfarbe erreicht man zum
          Beispiel mit
        ...
        <p>
          ...
          verwenden kann (<Tag>h1</Tag>, <Tag>body</Tag>, ...). Man kann aber
          auch Klassen und IDs verwenden.
        </p>
      </section>
      <section>
        <h3>CSS Klassen</h3>
        Klassen werden vermutlich am häufigsten verwendet in CSS. Klassen werden
        als Attribut in HTML (z.B.{" "}
        <ICode>
        ...
        <Example title="Aufgabe: Klassenselektor verwenden">
          ...
          verwendet. Sie können Sich dabei an dem folgenden Beispiel
          orientieren.
          <LCode
            content={`.important {
  border: 5px solid orange;
      ...
      <section>
        <h3>CSS IDs</h3>
        <p>
          Es können nicht nur Klassen sondern auch IDs verwendet werden. Dies
          wird oftmals gemacht wenn es sich um ein eindeutiges Element handelt,
          wie zum Beispiel eine Navigationsliste.
        </p>
        <p>
